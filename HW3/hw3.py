...
Original file is located at
    https://colab.research.google.com/drive/14LRCUoeBxcGgxNEpyphS-spApDLHZBFw
"""
...
class Car():
  ...
  def accelerate(self, upper_border=None, step=None):
    ...
    if self.state:
      ...
      print("Can't find the car on the road")
  ...
  def brake(self, lower_border=None, step=None):
    ...
    if lower_border != None and lower_border >= 0:
      ...
      self.current_speed -= 10
      print('current speed:', self.current_speed)
    else: print('lower_border is met:', self.current_speed)
